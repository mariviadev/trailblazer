...
interface CampSiteProps {
  ...
  title: string;
  subtitle: string;
  peopleJoined: string; // TODO change to peopleVisited
  className?: string; // TODONE add className prop
}
...
const CampSite = ({
  ...
  return (
    <div
      className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl ${className}`}
    >
